...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Occurrence.created'
        db.add_column('schedule_occurrence', 'created', orm['schedule.Occurrence:created'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Occurrence.created'
        db.delete_column('schedule_occurrence', 'created')
